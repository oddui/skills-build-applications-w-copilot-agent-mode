...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Direct MongoDB insertion for users
        users = [
        ...
        # Direct MongoDB insertion for teams
        teams = [
            {"_id": ObjectId(), "name": "Blue Team", "members": [user["_id"] for user in users]},
        ]
        db.teams.insert_many(teams)

        # Direct MongoDB insertion for activities
        activities = [
            {"_id": ObjectId(), "user": users[0]["_id"], "activity_type": "Cycling", "duration": "01:00:00"},
            {"_id": ObjectId(), "user": users[1]["_id"], "activity_type": "Crossfit", "duration": "02:00:00"},
            {"_id": ObjectId(), "user": users[2]["_id"], "activity_type": "Running", "duration": "01:30:00"},
            {"_id": ObjectId(), "user": users[3]["_id"], "activity_type": "Strength", "duration": "00:30:00"},
            {"_id": ObjectId(), "user": users[4]["_id"], "activity_type": "Swimming", "duration": "01:15:00"},
        ]
        db.activity.insert_many(activities)

        # Direct MongoDB insertion for leaderboard
        leaderboard = [
        ...
        # Direct MongoDB insertion for workouts
        workouts = [
